...
(Edm,Fdm) = getDMspectrum('x2','new',50,chan)
ax.plot(Edm, Fdm, label="m = 0.05 TeV", color='red', linewidth=1)

(Edm,Fdm) = getDMspectrum('x2','new',100,chan)
ax.plot(Edm, Fdm, label="m = 0.1 TeV", color='blue', linewidth=1)

(Edm,Fdm) = getDMspectrum('x2','new',150,chan)
ax.plot(Edm, Fdm, label="m = 0.15 TeV", color='green', linewidth=1)

(Edm,Fdm) = getDMspectrum('x2','new',250,chan)
ax.plot(Edm, Fdm, label="m = 0.25 TeV", color='pink', linewidth=1)

(Edm,Fdm) = getDMspectrum('x2','new',500,chan)
ax.plot(Edm, Fdm, label="m = 0.5 TeV", color='#00CCFF', linewidth=1)

(Edm,Fdm) = getDMspectrum('x2','new',1000,chan)
ax.plot(Edm, Fdm, label="m = 1 TeV", color='#FF66FF', linewidth=1)

(Edm,Fdm) = getDMspectrum('x2','new',5000,chan)
ax.plot(Edm, Fdm, label="m = 5 TeV", color='#CC0066', linewidth=1)

(Edm,Fdm) = getDMspectrum('x2','new',10000,chan)
ax.plot(Edm, Fdm, label="m = 10 TeV", color='orange', linewidth=1)

(Edm,Fdm) = getDMspectrum('x2','new',50000,chan)
ax.plot(Edm, Fdm, label="m = 50 TeV", color='purple', linewidth=1)
...
(Edm,Fdm) = getDMspectrum('e','new',50,chan)
ax.plot(Edm, Fdm, label="m = 0.05 TeV", color='red', linewidth=1)

(Edm,Fdm) = getDMspectrum('e','new',100,chan)
ax.plot(Edm, Fdm, label="m = 0.1 TeV", color='blue', linewidth=1)

(Edm,Fdm) = getDMspectrum('e','new',150,chan)
ax.plot(Edm, Fdm, label="m = 0.15 TeV", color='green', linewidth=1)

(Edm,Fdm) = getDMspectrum('e','new',250,chan)
ax.plot(Edm, Fdm, label="m = 0.25 TeV", color='pink', linewidth=1)

(Edm,Fdm) = getDMspectrum('e','new',500,chan)
ax.plot(Edm, Fdm, label="m = 0.5 TeV", color='#00CCFF', linewidth=1)

(Edm,Fdm) = getDMspectrum('e','new',1000,chan)
ax.plot(Edm, Fdm, label="m = 1 TeV", color='#FF66FF', linewidth=1)


(Edm,Fdm) = getDMspectrum('e','b',5000,chan,boost=4e4) #######
(Edm,Fdm) = getDMspectrum('e','Tau',5000,chan,boost=2e4) #######
(Edm,Fdm) = getDMspectrum('e','W',5000,chan,boost=4e4) #######
(Edm,Fdm) = getDMspectrum('e','new',5000,chan)
ax.plot(Edm, Fdm, label="m = 5 TeV", color='#CC0066', linewidth=1)


(Edm,Fdm) = getDMspectrum('e','new',10000,chan)
ax.plot(Edm, Fdm, label="m = 10 TeV", color='orange', linewidth=1)

(Edm,Fdm) = getDMspectrum('e','new',50000,chan)
ax.plot(Edm, Fdm, label="m = 50 TeV", color='purple', linewidth=1)
plt.legend(loc=3, prop={'size':12})
...
(Edm,Fdm) = getDMspectrum('e2','b',10,chan)
ax.plot(Edm, Fdm, label="DM", color='red', linewidth=1)

(Edm,Fdm) = getDMspectrum('e2','new',50,chan)
ax.plot(Edm, Fdm, label="m = 0.05 TeV", color='red', linewidth=1)

(Edm,Fdm) = getDMspectrum('e2','new',100,chan)
ax.plot(Edm, Fdm, label="m = 0.1 TeV", color='blue', linewidth=1)

(Edm,Fdm) = getDMspectrum('e2','new',150,chan)
ax.plot(Edm, Fdm, label="m = 0.15 TeV", color='green', linewidth=1)

(Edm,Fdm) = getDMspectrum('e2','new',250,chan)
ax.plot(Edm, Fdm, label="m = 0.25 TeV", color='pink', linewidth=1)

(Edm,Fdm) = getDMspectrum('e2','new',500,chan)
ax.plot(Edm, Fdm, label="m = 0.5 TeV", color='#00CCFF', linewidth=1)

(Edm,Fdm) = getDMspectrum('e2','new',1000,chan)
ax.plot(Edm, Fdm, label="m = 1 TeV", color='#FF66FF', linewidth=1)

(Edm,Fdm) = getDMspectrum('e2','new',5000,chan)
ax.plot(Edm, Fdm, label="m = 5 TeV", color='#CC0066', linewidth=1)

(Edm,Fdm) = getDMspectrum('e2','new',10000,chan)
ax.plot(Edm, Fdm, label="m = 10 TeV", color='orange', linewidth=1)

(Edm,Fdm) = getDMspectrum('e2','new',50000,chan)
ax.plot(Edm, Fdm, label="m = 50 TeV", color='purple', linewidth=1)
...
if 1:
    ...
    hdulist1 = fits.open('spectrumdmbboost.fits')
    hdulist1.info()
    ...
    hdulist2 = fits.open('spectrumdmWboost.fits')
    hdulist2.info()
